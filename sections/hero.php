<div class="hero-container">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <div class="relative">
        <div class="absolute inset-0 bg-gradient-to-r from-brand-primary-500/10 to-brand-secondary-500/10 rounded-3xl transform rotate-3"></div>
        <div class="absolute inset-0 bg-gradient-to-r from-brand-primary-500/10 to-brand-secondary-500/10 rounded-3xl transform -rotate-3"></div>
        <div class="relative rounded-2xl shadow-lg w-full overflow-hidden">
          <div class="grid grid-cols-2 gap-2 p-6 bg-white">
